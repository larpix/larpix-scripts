...
alias larpix-connect-to-daq-srv="xterm -e 'while true; do ssh ${BERN_DAQ_BOARD_LOGIN}; sleep 1; done' &"
alias larpix-run-srv="xterm -e \"while true; do ssh -t ${BERN_DAQ_BOARD_LOGIN} \\\"sudo ./setup; sudo halt\\\"; sleep 1; done\" &"
alias larpix-kill-srv="ssh -t ${BERN_DAQ_BOARD_LOGIN} \"sudo pkill -f \\\"pixlar\\\"\""
