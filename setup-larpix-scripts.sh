...
alias larpix-connect-to-daq="xterm -e 'while true; do ssh ubuntu@10.0.1.6; sleep 1; done' &"
alias larpix-run-daq="xterm -e \"while true; do ssh -t ubuntu@10.0.1.6 \\\"sudo ./setup; sudo halt\\\"; sleep 1; done\" &"
